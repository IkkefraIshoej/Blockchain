...
contract Bookshelf is ERC721 {
    ...
    mapping (uint => address) bookApprovals;

    function addBook(string memory _name, uint _year, string memory _author) public {
        uint id = bookList.push(Book(_name, _year, _author));
    ...
    function transferFrom(address _from, address _to, uint256 _tokenId) external payable {
        require (bookToOwner[_tokenId] == msg.sender || bookApprovals[_tokenId] == msg.sender);
